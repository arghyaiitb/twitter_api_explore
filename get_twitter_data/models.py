...
class Tweets(models.Model):
    ...
    created_at = models.DateTimeField()  # epoch time when the tweet was done
    author_id = models.BigIntegerField()  # match user data to tweet
    author_screen_name = models.CharField(max_length=100,default=None,null=True)
    favorite_count = models.IntegerField(default=0)  # likes on the tweet
    lang = models.CharField(max_length=10)  # language of the tweet
    geo_location = JSONField(default=None, null=True)  # location tagged in the tweet
